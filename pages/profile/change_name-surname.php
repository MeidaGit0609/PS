    ...
    <div class="container mt-5">
        <form action="/php/action/changes/change_name_surname-handler.php" class="form" method="post">
            <div class="form-group">
                <?=$_GET['change_n_srn'] == 'happy' ? '<div class="alert alert-success">Вы успешно изменили имя и фамилию</div>' : ''?>
                <?=$_GET['change_n_srn'] == 'name_surname-fail' ? '<div class="alert alert-danger">Поле заполнено неверно</div>' : ''?>
                <?=$_GET['change_n_srn'] == 'input_fail' ? '<div class="alert alert-danger">Заполните поле</div>' : ''?>
