                ...
                <div class="card-body">
                    <form method="POST" action="/php/action/registr-handler.php" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <?=$_GET['regist'] == 'phone-fail' ? '<div class="alert alert-danger">Номер введён неверно </div>' : ''?>

                            <?=$_GET['regist'] == 'email-fail' ? '<div class="alert alert-danger">Email введён неверно </div>' : ''?>

                            <label class="control-label" for="signupEmail">Email или номер телефона(без пробелов)</label>
                            <input id="signupEmail" name="email_or_phone" type="text" maxlength="50" class="form-control" required>
                        </div>
                        <div class="form-group">
